...
public class TodoApiTests
{
    ...
    public async Task GetAllTodoItems_ReturnsOkResultOfIEnumerableTodoItems()
    {
        ...
        var user = new ClaimsPrincipal(new ClaimsIdentity(new Claim[] { new(ClaimTypes.NameIdentifier, "user1") },
            "secret-1"));
    ...
    public async Task CreateTodoItem_ReturnsCreatedStatusWithLocation()
    {
        ...
        var todoItemOutputResult = await TodoApi.CreateTodoItem(
            testDbContextFactory, user, todoItemInput, new TodoItemInput.TodoItemInputValidator(testDbContextFactory));
    ...
    public async Task CreateTodoItem_ReturnsProblem()
    {
        ...
        var todoItemOutputResult = await TodoApi.CreateTodoItem(testDbContextFactory, user, todoItemInput,
            new TodoItemInput.TodoItemInputValidator(testDbContextFactory));
